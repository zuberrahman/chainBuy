...
export default function Detail({Data, DonationsData}) {
  ...
  useEffect(() => {
    const Request = async () => {
      ...
      fetch('https://crowdcrowdfund.infura-ipfs.io/ipfs/' + Data.storyUrl)
    ...
    <DetailWrapper>
      <LeftContainer>
        <ImageSection>
          <Image
            ...
            layout="fill"
            src={
              "https://crowdcrowdfund.infura-ipfs.io/ipfs/" + Data.image
            }
          />
        </ImageSection>
        <Text>
      ...
      <RightContainer>
        ...
        <DonateSection>
          ...
          <Donate onClick={DonateFunds}>Buy</Donate>
        </DonateSection>
        <FundsData>
          <Funds>
        ...
        <Donated>
          <LiveDonation>
            <DonationTitle>Recent Transaction</DonationTitle>
            {DonationsData.map((e) => {
              return (
          ...
          <MyDonation>
            <DonationTitle>My Past Transaction</DonationTitle>
            {mydonations.map((e) => {
              return (
                <Donation key={e.timestamp}>
                <DonationData>{e.donar.slice(0,6)}...{e.donar.slice(39)}</DonationData>
