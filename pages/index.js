  ...
  return (
    <HomeWrapper>
      ...
      <FilterWrapper>
        ...
        <Category onClick={() => setFilter(HealthData)}>Ornaments</Category>
        <Category onClick={() => setFilter(EducationData)}>Books</Category>
        <Category onClick={() => setFilter(AnimalData)}>Furniture</Category>
      </FilterWrapper>
        ...
        return (
          ...
          <CardImg>
            <Image 
              ...
              layout='fill' 
              src={"https://crowdcrowdfund.infura-ipfs.io/ipfs/" + e.image} 
            />
          </CardImg>
          <Title>
            {e.title}
